...
export const metadata = {
  ...
  title:
    'Подшипник HMG-200C | Закаленная сталь S45C | Масляные канавки | ВиВа Групп',
  description:
    'Стальной подшипник HMG-200C: закаленная сталь S45C, система смазки с масляными канавками, высокая ударопрочность. Доставка по России.',
  openGraph: {

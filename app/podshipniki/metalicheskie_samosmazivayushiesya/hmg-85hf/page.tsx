...
export const metadata = {
  ...
  title: 'Подшипник HMG-85HF | Fe-Cu сплав | Твердые смазочные компоненты',
  description:
    'Высокоскоростной подшипник HMG-85HF: стальная основа с медным сплавом, диспергированные смазочные компоненты, масляные поры. Эффективный теплоотвод.',
  openGraph: {
    title: 'Подшипник HMG-85HF | Высокая теплопроводность | Низкое трение',
    description:
      'Самосмазывающийся подшипник HMG-85HF: Fe-Cu матрица, твердые смазочные добавки, масляные резервуары. Для высоких скоростей и низких нагрузок.',
    url:
      process.env.URL +
  ...
  keywords:
    'HMG-85HF, Fe-Cu сплав, твердые смазочные компоненты, высокоскоростной подшипник',
};

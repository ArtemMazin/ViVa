...
export const metadata = {
  ...
  title: 'Подшипник HMG-650 | Бронзографит | Для тяжелых нагрузок',
  description:
    'Бронзографитовый подшипник HMG-650: ориентированные смазочные компоненты, высокая ударопрочность, работа при частых пусках-остановках.',
  openGraph: {
    title:
      'Подшипник HMG-650 | Бронзографитовый композит | Промышленное применение',
    description:
      'Самосмазывающийся подшипник HMG-650: надежная смазочная пленка, максимальная грузоподъемность. Для литьевых машин, портового оборудования.',
    url:
      process.env.URL +
  ...
  keywords:
    'HMG-650, бронзографитовый подшипник, высокая грузоподъемность, литьевые машины',
};

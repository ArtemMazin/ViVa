...
export const metadata = {
  ...
  title: 'Подшипник HMG-650GT | Биметалл до 300°C | Экономичное решение',
  description:
    'Биметаллический подшипник HMG-650GT: стальная основа, бронзовый слой, термостойкость 300°C. Для высоких нагрузок и частых пусков-остановок.',
  openGraph: {
    title: 'Подшипник HMG-650GT | Сталь-бронза | Высокотемпературный',
    description:
      'Биметаллический подшипник HMG-650GT: ориентированные смазочные компоненты, максимальная прочность, работа при 300°C. Оптимальная стоимость.',
    url:
      process.env.URL +
  ...
  keywords:
    'HMG-650GT, биметаллический подшипник, термостойкость 300°C, сталь-бронза',
};

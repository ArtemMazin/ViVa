...
const page = () => {
  const productJsonLd = {
    ...
    '@type': 'Product',
    name: 'HMG-800/815',
    image: `${process.env.URL}/image/pages/hmg800-815/hmg800-815.jpg`,
    description:
      'Биметаллический подшипник с бронзово-свинцовым слоем CuSb10Pb10 (HMG-800) или CuSn10Pb5 (HMG-815) на стальной основе. Высокая износостойкость и низкий коэффициент трения.',
    brand: {
      '@type': 'Brand',
      name: 'HMG',
    },
    ...
    additionalProperty: [
      {
        '@type': 'PropertyValue',
        name: 'Тип',
        value: 'Биметаллический подшипник',
      },
      {
        '@type': 'PropertyValue',
        name: 'Сплав',
        value: 'CuSb10Pb10/CuSn10Pb5',
      },
    ],
    offers: {
      '@type': 'Offer',
      ...
      <main className={`${styles.section} container`}>
        ...
        <section>
          ...
          <Ptag margin="bottom">
            ...
            средних-низких скоростях вращения. Подшипники могут
            эксплуатироваться в запыленной среде и в условиях загрязнений.
            Типичные области применения включают шатуны, опорные катки ходовой
            части, проушины штоков гидроцилиндров, погрузочно-разгрузочное
            оборудование, сельскохозяйственную и лесную технику и т.д. Оба
            материала содержат свинец, использование которого ограничено для
            некоторых специальных деталей согласно соответствующим законам или
            нормативам.
          </Ptag>
        </section>
      </main>

...
const page = () => {
  const productJsonLd = {
    ...
    '@type': 'Product',
    name: 'HMG-090',
    image: `${process.env.URL}/image/pages/hmg090/hmg090.jpg`,
    description:
      'Тонкостенная свёртная втулка из бронзового сплава CuSn8. Внутренняя насечка для смазки, высокая теплопроводность, коррозионная стойкость.',
    brand: {
      '@type': 'Brand',
      name: 'HMG',
    },
    ...
    additionalProperty: [
      ...
      },
      {
        '@type': 'PropertyValue',
        name: 'Особенности',
        value: 'Внутренняя насечка для смазки',
      },
    ],
    offers: {
      '@type': 'Offer',
        ...
        <section className={styles.flex}>
          ...
          <div>
            ...
            <Ptag>
              ...
              Внутренний диаметр втулки можно дополнительно обрабатывать после
              сборки узла. Бронзовый сплав обеспечивает хорошую коррозионную
              стойкость и эффективный отвод тепла благодаря высокой
              теплопроводности. Данная втулка оптимальна для применения при
              средних и низких нагрузках, а также низких скоростях вращения, при
              этом рекомендуется периодическая смазка.
            </Ptag>
          </div>
        </section>
        <section className={styles.flex}>

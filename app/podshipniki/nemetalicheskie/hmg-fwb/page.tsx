...
export const metadata = {
  ...
  title: 'Подшипник HMG-FWB | Стекловолокно + ПТФЭ | Химстойкий | ВиВа Групп',
  description:
    'Композитный подшипник HMG-FWB: стекловолокно с эпоксидной смолой, высокие нагрузки, работа в запыленной среде. Доставка по России.',
  openGraph: {

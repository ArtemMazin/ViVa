...
import { flex, table, cell, image, section, scroll } from './hmg80.module.css';
    ...
    <main className={`${section} container`}>
      ...
      <section className={flex}>
        ...
        <div>
          ...
          <Ptag tag='p'>
            ...
            Масляное месторождение может удерживать смазку с оптимизированной матрицей и удерживать возможные входящие
            загрязнения во время работы. Смазка во время эксплуатации помогает продлить срок службы подшипника. Широкий
            диапазон рабочих температур от -150°C до +250°C и надежная химическая стойкость подшипника обеспечивают
            подходящее применение в условиях средних и высоких нагрузок. HMG-80M представляет собой материал с толщиной
            PEEK/ПТФЭ 0,1-0,2 мм без масляных отложений на поверхности, после сборки он поддается механической
            обработке.
          </Ptag>
        </div>
      </section>
      <section className={flex}>
        <div>
          ...
          <Ptag tag='p'>
            1. Толщина PEEK/ПТФЭ 0,20–0,35 мм обеспечивает хорошую износостойкость. На этой опорной поверхности имеется
            узор из круглых углублений, которые при сборке подшипника следует заполнить смазкой.
          </Ptag>
          <Ptag tag='p'>
            2. Спеченная бронза толщиной 0,20-0,35 мм обеспечивает прочное механическое соединение и отличную
            теплопроводность.
          </Ptag>
      ...
      <section>
        ...
        <Ptag tag='p'>
          Материал имеет широкий диапазон рабочих температур и может использоваться в условиях высоких значений PV. Оно
          используется в гидравлических двигателях, насосах, системе Common Rail дизельных двигателей и тормозных
          системах тяжелых грузовиков.
        </Ptag>
      </section>
    </main>
  );

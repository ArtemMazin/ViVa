...
export const metadata = {
  title: 'Доставка подшипников HMG | Отправка по России | ВиВа Групп',
  description:
    'Доставка подшипников HMG: самовывоз со склада в Подмосковье или отправка через СДЭК, DPD, Деловые Линии. Отслеживание грузов онлайн, гарантия сохранности. Работаем со всеми регионами России.',
  openGraph: {

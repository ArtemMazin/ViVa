...
export const metadata = {
  ...
  description:
    'Доставка подшипников HMG: самовывоз со склада в Подмосковье, отправка через СДЭК, DPD, Деловые Линии. Отслеживание грузов, гарантия сохранности.',
  openGraph: {
    title: 'Доставка подшипников HMG | Вся Россия и СНГ | ВиВа Групп',
    description:
      'Быстрая доставка подшипников HMG: склад в Московской области, надёжные транспортные компании, полное сопровождение груза. Работаем по всей России.',

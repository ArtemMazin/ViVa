  ...
  return (
    <main className={`container ${styles.privacy}`}>
      ...
      <Ptag tag="p">
        ...
        безопасности персональных данных, предпринимаемые ООО "ВиВа Групп"
        (далее — Оператор).
      </Ptag>
      <Ptag tag="p">
      ...
      <Ptag tag="p">
        ...
        сети интернет по сетевому адресу https://vi-va.vercel.app.
      </Ptag>
      <Ptag tag="p">
      ...
      <Ptag tag="p">
        ...
        обработку персональных данных, а также, на направление требования о
        прекращении обработки персональных данных; — обжаловать в уполномоченный
        орган по защите прав субъектов персональных данных или в судебном
        порядке неправомерные действия или бездействие Оператора при обработке
        его персональных данных; — на осуществление иных прав, предусмотренных
      ...
      <Ptag tag="p">
        Цель обработки: уточнение деталей заказа. Персональные данные:
        электронный адрес, номер телефона. Правовые основания: Федеральный закон
        «Об информации, информационных технологиях и о защите информации» от
        27.07.2006 N 149-ФЗ Виды обработки персональных данных Передача
        персональных данных
      </Ptag>
      <Ptag tag="p">
      ...
      <Ptag tag="p">
        ...
        уведомление на адрес электронной почты Оператора info@gidmash.ru с
      ...
      <Ptag tag="p">
        ...
        электронный адрес Оператора info@gidmash.ru с пометкой «Отзыв согласия
      ...
      <Ptag tag="p">
        ...
        Оператору с помощью электронной почты info@gidmash.ru.
      </Ptag>
      <Ptag tag="p">
      ...
      <Ptag tag="p">
        ...
        Интернет по адресу https://vi-va.vercel.app/privacy.
      </Ptag>
    </main>
  );
}

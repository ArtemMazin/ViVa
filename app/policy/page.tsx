...
export const metadata = {
  ...
  description:
    'Политика обработки персональных данных ООО "ВиВа Групп" в соответствии с ФЗ №152 "О персональных данных". Обеспечение безопасности и порядок обработки данных.',
  robots: {
    index: false,
    follow: true,
  },
...
export default function Policy() {
  return (
    <main className={`container ${styles.policy}`}>
      <BreadCrumbs
      ...
      <Ptag>
        ...
        безопасности персональных данных, предпринимаемые ООО &quot;ВиВа
        Групп&quot; (далее — Оператор).
      </Ptag>
      <Ptag>

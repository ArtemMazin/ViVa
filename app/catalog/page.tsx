...
export const metadata = {
  ...
  description:
    'Полный каталог подшипников HMG: цилиндрические, фланцевые втулки, упорные кольца. Склад в Подмосковье, техподдержка, изготовление по чертежам.',
  openGraph: {
    title: 'Каталог подшипников HMG | Все типоразмеры в наличии | ВиВа Групп',
    description:
      'Каталог подшипников HMG: стандартные размеры на складе, изготовление по чертежам. Техническая поддержка, быстрая доставка по России.',
